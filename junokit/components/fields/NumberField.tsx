...
export type NumberFieldProps = NumberFieldDataProps &
	Omit<React.HTMLAttributes<HTMLDivElement>, keyof NumberFieldDataProps>;
...
export default function NumberField(props: NumberFieldProps) {
	...
	const handleFocus = (e: React.FocusEvent<HTMLInputElement>) => {
		setIsEditing(true);
		// Sync internal to current display on focus
	...
	const arrowButton = showArrows && !rightIcon && (
		<ArrowButtons size={size} currentValue={currentNumericValue} min={min} max={max} onIncrement={increment} />
	);
