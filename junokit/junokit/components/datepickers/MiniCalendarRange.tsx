...
const MiniCalendarRange = forwardRef<HTMLDivElement, MiniCalendarRangeProps>((props, ref) => {
	...
	const classes = [
		`flex ${flexDirection} relative items-stretch`,
		"w-fit select-none focus:outline-none",
		sizeStyles[size],
		standaloneStyles,
		"group/calendar",
		className,
	...
	return (
		<div id={mainDivId} {...extraProps} className={classes} tabIndex={0} ref={mainDivRef} style={style}>
			{layout === "single" ? (
				<CalendarPanelRange
